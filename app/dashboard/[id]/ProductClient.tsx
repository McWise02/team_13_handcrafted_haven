    ...
    <>
      <div className="min-h-screen bg-blue-50 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-blue-700 hover:text-blue-900 mb-8 font-medium transition-colors"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-3xl shadow-2xl overflow-hidden border border-blue-100">
            ...
            <div className="relative">
              ...
              {otherImages.length > 0 && (
                <div className="grid grid-cols-4 gap-3 p-6 bg-gradient-to-t from-blue-50 to-transparent">
                  {otherImages.map((img: string, i: number) => (
                    <div
                      key={i}
                      className="aspect-square relative rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-200 shadow-md border border-blue-200"
                    >
                      <Image
                        src={img}
            ...
            <div className="flex flex-col justify-between p-8 lg:p-12">
              <div>
                ...
                <div className="text-5xl lg:text-6xl font-bold text-blue-600 mb-10 tracking-tight">
                  {formatPrice(product.price)}
                </div>

                <button
                  onClick={() => setIsModalOpen(true)}
                  className="group mb-10 inline-flex items-center gap-4 bg-blue-100 hover:bg-blue-200 text-blue-900 font-semibold text-lg py-5 px-10 rounded-2xl transition-all shadow-lg hover:shadow-xl"
                >
                  <ScrollText className="h-7 w-7 text-blue-700 group-hover:rotate-3 transition-transform" />
                ...
                <div className="space-y-8 text-gray-700">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-blue-600 font-medium">Handcrafted by</p>
                      <p className="text-2xl font-bold text-blue-900">{sellerName}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-blue-600 font-medium">Listed on</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-10 bg-blue-50/80 overflow-y-auto max-h-[60vh]">
              ...
              <div className="prose prose-lg prose-blue max-w-none text-gray-800 leading-loose">
